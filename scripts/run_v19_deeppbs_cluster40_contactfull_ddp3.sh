...
SEED="${SEED:-42}"
EPOCHS="${EPOCHS:-225}"
OUT_ROOT="${OUT_ROOT:-/data1/leihuang/project/TFScope/checkpoints/v19_deeppbs_cluster40_contactfull}"
...
command=(
    ...
    --contact-distill-weight 0.5
    --contact-targets-path data/contact_maps/contact_targets_cluster40trainonly.json
