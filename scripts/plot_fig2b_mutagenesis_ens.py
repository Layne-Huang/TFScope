...
Reads results/per_family_v24_ens/alascan_population.json (from alascan_population.py).
"""
...
D = json.load(open("results/per_family_v24_ens/alascan_population.json"))  # geometric base contacts
...
out = "figures_v24_ensemble/figure2b_mutagenesis/figure2b_mutagenesis"
