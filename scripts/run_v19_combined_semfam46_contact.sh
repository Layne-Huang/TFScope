...
SEED="${SEED:-42}"
EPOCHS="${EPOCHS:-225}"
OUT_ROOT="${OUT_ROOT:-/data1/leihuang/project/TFScope/checkpoints/v19_combined_semfam46_contact}"
...
command=(
    ...
    scripts/train.py
    --data data/processed/tf_pwm_combined_famv2.parquet
    --split data/processed/splits/combined_fm_deeppbs/split.json
    --out "$OUT_DIR"
    --seed "$SEED"
    --epochs "$EPOCHS"
    ...
    --pwm-head-v18
    --num-families 46
    --family-embedding-path /afs/csail.mit.edu/u/l/leihuang/project/TFScope/data/processed/family_embeddings_famv2.pt
