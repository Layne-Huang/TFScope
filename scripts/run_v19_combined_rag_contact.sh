...
SEED="${SEED:-42}"
EPOCHS="${EPOCHS:-225}"
OUT_ROOT="${OUT_ROOT:-/data1/leihuang/project/TFScope/checkpoints/v19_combined_rag_contact}"
...
command=(
    ...
    --retrieval-index-path data/processed/tf_nn_index_combined_fm_deeppbs.json
