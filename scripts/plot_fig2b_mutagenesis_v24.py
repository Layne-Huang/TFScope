...
Reads results/per_family_v24/alascan_population.json (from alascan_population.py).
"""
...
D = json.load(open("results/per_family_v24/alascan_population.json"))  # geometric base contacts
...
out = "figures_v24/figure2b_mutagenesis/figure2b_mutagenesis"
