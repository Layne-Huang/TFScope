...
SEED="${SEED:-42}"
EPOCHS="${EPOCHS:-50}"
OUT_ROOT="${OUT_ROOT:-/data1/leihuang/project/TFScope/checkpoints/v19_e7_position_gate_lora_fixed_ddp9}"
...
RUN_NAME="${RUN_NAME:-e7_position_gate_seed${SEED}}"
...
echo "Starting E7 position-wise retrieval gate seed $SEED on GPUs $GPU_IDS"
echo "Log: $LOG"
