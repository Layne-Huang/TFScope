...
OUTD="figures_v24_ensemble/figure3a_heldout_recovery"; RES="figures_v24_ensemble/figure3a_heldout_recovery"; os.makedirs(OUTD,exist_ok=True)
...
for r in held.itertuples():
    ...
    g,pp,_=infer_ens(models,tok,mask,FID.get(r.family_name,9),ret=None)
