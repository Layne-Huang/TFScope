...
SEED="${SEED:-42}"
EPOCHS="${EPOCHS:-225}"
OUT_ROOT="${OUT_ROOT:-/data1/leihuang/project/TFScope/checkpoints/v19_combined_semfam34_contact_fixed}"
...
command=(
    ...
    --pwm-head-v18
    --num-families 34
    --family-embedding-path /afs/csail.mit.edu/u/l/leihuang/project/TFScope/data/processed/family_embeddings_rebin34_fixed.pt
