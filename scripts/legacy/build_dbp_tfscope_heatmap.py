...
CKDIR="/data1/leihuang/project/TFScope/checkpoints/v19_combined_fm_deeppbs_contact/rag_seed42"
OUT="figures/figure_dbp_heatmap"; os.makedirs(OUT,exist_ok=True)
