...
SEED="${SEED:-42}"
EPOCHS="${EPOCHS:-225}"
OUT_ROOT="${OUT_ROOT:-/data1/leihuang/project/TFScope/checkpoints/v19_deeppbs_benchmark}"
...
command=(
    ...
    --retrieval-index-path data/processed/tf_nn_index_deeppbs_benchmark.json
)
