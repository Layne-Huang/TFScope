...
SEED="${SEED:-42}"
EPOCHS="${EPOCHS:-225}"
OUT_ROOT="${OUT_ROOT:-/data1/leihuang/project/TFScope/checkpoints/v19_deeppbs_cluster40_semfam10}"
...
command=(
    ...
    --oracle-r-n-tfs 40
    --pwm-head-v18
    --family-embedding-path /afs/csail.mit.edu/u/l/leihuang/project/TFScope/data/processed/family_embeddings_10.pt
    --precision bf16
    --tf32
    --no-wandb
)
