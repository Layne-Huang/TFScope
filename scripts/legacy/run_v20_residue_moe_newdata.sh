...
OUT_ROOT="${OUT_ROOT:-/data1/leihuang/project/TFScope/checkpoints/v20_residue_moe_newdata}"
PYTHON_BIN="${PYTHON_BIN:-/data1/leihuang/miniconda3/envs/tfscope/bin/python}"
TORCH_HOME="${TORCH_HOME:-/data1/leihuang/.cache/torch}"
RUN_NAME="${RUN_NAME:-residue_moe_v2_seed${SEED}}"
...
command=(
    ...
    --data data/processed/tf_pwm_training_v2.parquet
